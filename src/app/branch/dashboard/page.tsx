      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-white/40 mt-1 flex items-center gap-2">
            {orders.length} active orders requiring attention
            {socketConnected
        ...
        <button onClick={fetchOrders} className="p-3 bg-background rounded-xl shadow-sm hover:bg-background text-white/60 transition-colors" title="Manual refresh">
